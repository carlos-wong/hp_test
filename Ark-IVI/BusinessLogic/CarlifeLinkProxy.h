#ifndef CARLIFELINKPROXY
#define CARLIFELINKPROXY
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<> reqeustBTInfo(const int status)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(status);
        return asyncCallWithArgumentList(QLatin1String("reqeustBTInfo"), argumentList);
    }
